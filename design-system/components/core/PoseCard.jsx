...
export function PoseCard({ name, difficulty, thumbnail, onClick, selected = false }) {
  return (
    <button
      onClick={onClick}
      style={{
    ...
    >
      ...
      <div style={{ flex: 1, textAlign: 'center' }}>
        <div style={{ fontFamily: 'var(--font-display)', fontSize: 28, letterSpacing: 'var(--tracking-display)', textTransform: 'uppercase', color: 'var(--ink)', lineHeight: 1.1 }}>{name}</div>
